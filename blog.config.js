...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2024-2025, // e.g if leave this empty, current year will be used.
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Free writing', // 作者简介
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'https://cloudring2004@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'http://3650000.xyz/api/360.php?cid=26', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || 'XICP备XXXXXXX', // 备案号 闽ICP备XXXXXXX
